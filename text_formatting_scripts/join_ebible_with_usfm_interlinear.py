...
def combine_verses(eng_verses, tmz_verses):
    ...
    for ref in sorted(all_refs):
        if ref in eng_dict and ref in tmz_dict:  # Check if there is a match in both dictionaries
            ...
            combined.append(f"\u202A__{ref_formatted}_ara\u202C \u202B{eng_content}\u202C \u202A__{ref_formatted}_tmz\u202C \u202B{tmz_content}\u202C")

    return combined

# Load verses from ScriptureReference
ebible_verses = ScriptureReference('Gen 1:1', 'Rev 22:21', 'arb-arbnav').verses
...
output_path = 'C:/Users/caleb/Bible Translation Project/No code/Tamazight/text/output/arb_tmz_verses.txt'
